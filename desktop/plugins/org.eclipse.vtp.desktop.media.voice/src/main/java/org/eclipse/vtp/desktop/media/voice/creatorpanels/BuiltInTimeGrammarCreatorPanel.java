...
import org.eclipse.vtp.framework.interactions.voice.media.BuiltInTimeInputGrammar;

public class BuiltInTimeGrammarCreatorPanel extends InputGrammarCreatorPanel
{
	BuiltInTimeInputGrammar grammar = new BuiltInTimeInputGrammar();
    ...
    {
		if(content instanceof BuiltInTimeInputGrammar)
			grammar = (BuiltInTimeInputGrammar)content;
   }
