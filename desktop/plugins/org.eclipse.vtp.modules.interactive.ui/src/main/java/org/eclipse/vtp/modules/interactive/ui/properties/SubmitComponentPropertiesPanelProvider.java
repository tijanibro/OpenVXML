 ...
 *
 */
public class SubmitComponentPropertiesPanelProvider implements
	ComponentPropertiesPanelProvider
{
	 ...
	 * 
	 */
	public SubmitComponentPropertiesPanelProvider()
	{
	}
		...
		IDesignComponent designComponent)
	{
		...
		ret.add(new SubmitPropertiesPanel("General", pe));
		return ret;
	}
	...
	public boolean isApplicableFor(IDesignComponent designComponent)
	{
		if(!(designComponent instanceof PrimitiveElement))
			return false;
		PrimitiveElement pe = (PrimitiveElement)designComponent;
		return pe.getSubTypeId().equals("org.eclipse.vtp.modules.interactive.submit");
