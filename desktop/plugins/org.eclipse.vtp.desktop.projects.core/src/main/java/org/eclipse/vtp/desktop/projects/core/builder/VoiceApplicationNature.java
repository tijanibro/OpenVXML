 ...
 * the <code>VoicePersonaNature</code> are visible in the OpenVXML
 ...
 * @deprecated
 */
public class VoiceApplicationNature implements IProjectNature
{
	/**
	 * Constant string containing the nature id
	 */
	public static final String NATURE_ID =
		"org.eclipse.vtp.desktop.projects.core.VoiceApplicationNature";
	...
	public void configure() throws CoreException
	{
		...
		for(int i = 0; i < commands.length; ++i)
		{
			if(commands[i].getBuilderName()
							  .equals(VoiceApplicationBuilder.BUILDER_ID))
			{
				return;
			}
		}
		...
		command.setBuilderName(VoiceApplicationBuilder.BUILDER_ID);
