...
/**
 * This class encapsulates the possible data types assigned to database table
 * columns. Only the standard SQL-92 types are supported.
 *
 * @author Trip Gilman
 * @version 2.0
 */
public class ColumnType {
	...
	/**
	 * A flag indicating wheather a NULL value is acceptable. Default is
	 * <code>true</code>.
	 */
	...
	/**
	 * Creates a new <code>ColumnType</code> with the given type name and data
	 * storage length.
	 *
	 * @param typeName
	 *            The name of the column data type
	 * @param length
	 *            The number of bytes used to store the column values
	 */
	...
	/**
	 * Determines if the data type of the column can also be configured to auto
	 * increment.
	 *
	 * @return <code>true</code> if the column is a NUMBER | BIGNUMBER,
	 ...
	 *
	 * @return <code>true</code> if the column will accept or contain NULL
	...
	/**
	 * @return <code>true</code> if the column is configured to auto increment,
	 *         <code>false</code> otherwise.
	 */
	 ...
	 * information for this column type.
	 *
	 * @param parent
	 *            The parent XML DOM element that will contain the column type
	 *            information
	 */
	 ...
	 *
	 * @param typeName
	 *            The data type name for the column type
	 * @param length
	 *            The number of bytes used to store this column types values
	 * @param nullable
	 *            A flag indicating whether this column type will accept or
	 *            contain NULL values
	 * @param autoIncrement
	 *            A flag indicating whether this column type will automatically
	 *            increment when new records are added to its database table
	 * @return A <code>ColumnType</code> instance representing the given column
	 *         type information
	 */
	...
	/**
	 * Constructs a new <code>ColumnType</code> from the information stored in
	...
	public static ColumnType load(Element element) {
		...
		ret.nullable = Boolean.valueOf(element.getAttribute("nullable"))
				.booleanValue();
		ret.autoIncrement = Boolean.valueOf(
				element.getAttribute("autoIncrement")).booleanValue();
