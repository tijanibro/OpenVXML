...
public class MediaConfigurationScreenManager {
	 ...
	 * @return
	 */
	public Map<String, MediaConfigurationScreen> getIndexedMediaConfigurationScreens(
			String primitiveTypeId, MediaConfigurationScreenContainer container) {
