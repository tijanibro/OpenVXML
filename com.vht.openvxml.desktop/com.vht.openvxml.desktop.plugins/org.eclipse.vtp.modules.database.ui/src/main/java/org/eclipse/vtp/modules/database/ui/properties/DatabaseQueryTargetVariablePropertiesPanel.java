...
public class DatabaseQueryTargetVariablePropertiesPanel extends
	 ...
	 * @param name
	 */
	public DatabaseQueryTargetVariablePropertiesPanel(PrimitiveElement dqe,
			DatabaseQuerySettingsStructure settings) {
	...
	public void createControls(Composite parent) {
		...
		List<IBusinessObject> bol = businessObjectAspect.getBusinessObjectSet()
				.getBusinessObjects();
		...
		newVariableSecureButton.setSelection(!settings.targetVariableExists
				&& settings.isTargetVariableSecure());
