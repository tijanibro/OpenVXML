...
public class DatabaseQuerySearchCriteriaPropertiesPanel extends
	...
	public DatabaseQuerySearchCriteriaPropertiesPanel(PrimitiveElement dqe,
		...
		IDatabaseProjectAspect databaseAspect = (IDatabaseProjectAspect) project
				.getProjectAspect(IDatabaseProjectAspect.ASPECT_ID);
	...
	public void createControls(Composite parent) {
		...
		criteriaTable.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.detail == 32) {
					DatabaseQuerySettingsStructure.SelectionCriteria criteria = (DatabaseQuerySettingsStructure.SelectionCriteria) ((TableItem) e.item)
							.getData();
	...
	public class ValueCellModifier implements ICellModifier {
		...
		public void modify(Object element, String property, Object value) {
			DatabaseQuerySettingsStructure.SelectionCriteria criteria = (DatabaseQuerySettingsStructure.SelectionCriteria) ((TableItem) element)
					.getData();
