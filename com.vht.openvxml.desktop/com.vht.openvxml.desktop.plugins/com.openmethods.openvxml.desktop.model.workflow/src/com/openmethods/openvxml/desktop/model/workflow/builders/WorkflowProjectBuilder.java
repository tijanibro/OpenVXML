...
public class WorkflowProjectBuilder extends IncrementalProjectBuilder {
	 ...
	 */
	public static final String BUILDER_ID = "com.openmethods.openvxml.desktop.model.workflow.WorkflowProjectBuilder";
	...
	private class RemovalDeltaVisitor implements IResourceDeltaVisitor {
		...
		public boolean visit(IResourceDelta delta) throws CoreException {
			...
			if (resource instanceof IFile
				...
				// resource.deleteMarkers(WorkflowMarkerConstants.WORKFLOW_MARKER,
				// true, IResource.DEPTH_INFINITE);
				return false;
			}
			return true;
