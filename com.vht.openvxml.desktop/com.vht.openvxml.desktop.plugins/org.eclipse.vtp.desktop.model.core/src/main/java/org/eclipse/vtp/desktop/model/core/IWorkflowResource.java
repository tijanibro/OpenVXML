...
/**
 * This is the base interface for the OpenVXML project object model. It provides
 * the baseline functions for all resource objects. It also provides a simple
...
public interface IWorkflowResource extends IAdaptable {
	...
	/**
	 * Adds the provided refresh listener to the list of listeners that will be
	 * notified if this resource should be refreshed.
	 *
	 * @param listener
	 *            The listener to add
	 */
	...
	/**
	 * Removes the provided refresh listener from the list of listeners that
	 * will be notified of refresh events.
	 *
	 * @param listener
	...
	/**
	 * Causes all refresh events for this resource to be ignored until
	 * resumeEvents() is called.
	 */
	public void deferEvents();

	/**
	 * Causes refresh events to once again be propagated to this resources
	 * listeners after deferEvents() has been called. This will automatically
	 * generate a refresh event to ensure any changes to this resource while
	 * events were deferred are propagated to its listeners.
	 */
