...
public class QuestionMediaDefaultsPanel implements IMediaDefaultPanel {
			...
			lastStack.setValueControl(new ValueControl() {
				...
				public String getValue() {
					return terminationCharacterCombo
							.getItem(terminationCharacterCombo
									.getSelectionIndex());
				}
	...
	public void save() {
		if (settings.inheritanceSupported()) {
			...
			settings.getDefaultSetting(interactionType, elementType,
					"termination-character").setValue(
					terminationCharacterCombo.getItem(terminationCharacterCombo
							.getSelectionIndex()));
			settings.getDefaultSetting(interactionType, elementType,
		...
		if (settings.inheritanceSupported()) {
			...
			if (interdigitTimeoutSpinner != null) {
				...
				interdigitTimeoutSpinner.setSelection(interdigitTimeout == null
						|| interdigitTimeout.equals("") ? 3 : Integer
			...
			if (terminationCharacterCombo != null) {
				String terminationCharacter = settings.getDefaultSetting(
						interactionType, elementType, "termination-character")
						.getValue();
