...
public class DocumentConverter {
	...
	public boolean convertModel(org.w3c.dom.Element modelElement)
		...
		while (!XML_VERSION.equals(modelXMLVersion)) // model version is
														// incorrect
		{
			...
			if (tempVersion.equals(modelXMLVersion)) // avoid infinite loop
														// caused by bad
														// converters
			{
				System.err
	...
	public final boolean convertElementConfiguration(
		...
		if (configurationList.getLength() > 0) {
			...
			do {
				...
				managedConfigSectionList = configurationElement
						.getElementsByTagName("managed-config");
