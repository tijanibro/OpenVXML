	...
	public void convertProject(IProject project) {
		try {
			...
			if (project.hasNature(WorkflowProjectNature.NATURE_ID)
				...
				Element aspectsElement = rootElement.getOwnerDocument()
						.createElement("project-aspects");
				rootElement.appendChild(aspectsElement);
				NodeList brandsElementList = rootElement
						.getElementsByTagName("brands");
				Element brandsElement = (Element) brandsElementList.item(0);
				Element typeSupportElement = null;
				NodeList typeSupportElementList = rootElement
						.getElementsByTagName("interaction-type-support");
				if (typeSupportElementList.getLength() > 0) {
					typeSupportElement = (Element) typeSupportElementList
							.item(0);
				}
				Element mediaDefaultsElement = null;
				NodeList mediaDefaultsElementList = rootElement
						.getElementsByTagName("media-defaults");
				if (mediaDefaultsElementList.getLength() > 0) {
					mediaDefaultsElement = (Element) mediaDefaultsElementList
							.item(0);
				}
				...
				Element dependenciesAspectElement = buildPathDocument
						.createElement("aspect");
				dependenciesAspectElement
						.setAttribute("id",
								"com.openmethods.openvxml.desktop.model.aspect.dependencies");
				aspectsElement.appendChild(dependenciesAspectElement);
				Element businessObjectAspectElement = buildPathDocument
						.createElement("aspect");
				businessObjectAspectElement
						.setAttribute("id",
								"com.openmethods.openvxml.desktop.model.aspect.businessobjects");
				aspectsElement.appendChild(businessObjectAspectElement);
				Element workflowAspectElement = buildPathDocument
						.createElement("aspect");
				workflowAspectElement
						.setAttribute("id",
								"com.openmethods.openvxml.desktop.model.aspect.workflow");
				aspectsElement.appendChild(workflowAspectElement);
				Element brandAspectElement = buildPathDocument
						.createElement("aspect");
				aspectsElement.appendChild(brandAspectElement);
				brandAspectElement
						.setAttribute("id",
								"com.openmethods.openvxml.desktop.model.aspect.branding");
				brandAspectElement.appendChild(brandsElement);
				if (typeSupportElement != null) {
					Element languageAspectElement = buildPathDocument
							.createElement("aspect");
					languageAspectElement
							.setAttribute("id",
									"com.openmethods.openvxml.desktop.model.aspect.languagesupport");
				...
				if (mediaDefaultsElement != null) {
					Element interactiveAspectElement = buildPathDocument
							.createElement("aspect");
					interactiveAspectElement
							.setAttribute("id",
									"com.openmethods.openvxml.desktop.model.aspect.interactive");
				...
				t.transform(new DOMSource(buildPathDocument), new XMLWriter(
						baos).toXMLResult());
				...
				description
						.setNatureIds(new String[] { WorkflowProjectNature5_0.NATURE_ID });
