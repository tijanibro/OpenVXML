...
public class InteractiveWorkflowCore extends AbstractUIPlugin {
	...
	protected void initializeDefaultPreferences(IPreferenceStore store) {
		...
		System.err
				.println("value of org.eclipse.vtp.framework.interactions.voice.interaction:org.eclipse.vtp.modules.interactive.playPrompt:barge-in: "
						+ store.getString("org.eclipse.vtp.framework.interactions.voice.interaction:org.eclipse.vtp.modules.interactive.playPrompt:barge-in"));
	}
