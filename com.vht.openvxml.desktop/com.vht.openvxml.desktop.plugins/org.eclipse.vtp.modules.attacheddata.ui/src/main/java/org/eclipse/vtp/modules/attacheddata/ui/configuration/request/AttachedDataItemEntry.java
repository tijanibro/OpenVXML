 ...
 * requested. It contains the name of the data point as well as the location the
 * value retrieved should be stored in.
 * 
 * @author trip
 */
public class AttachedDataItemEntry {
	 ...
	 * 
	 * @param value
	 *            The name of the variable to place the value into
	 */
	...
	/**
	 * Retrieves the name of the variable that will hold the attached data
	 * value.
	 * 
