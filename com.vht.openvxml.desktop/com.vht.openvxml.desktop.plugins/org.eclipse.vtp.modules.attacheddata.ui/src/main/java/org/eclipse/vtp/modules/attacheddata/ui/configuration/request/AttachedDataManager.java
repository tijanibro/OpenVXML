...
public class AttachedDataManager implements ConfigurationManager {
	...
	public static final String CONFIGURATION_TYPE_ID = "org.eclipse.vtp.configuration.attacheddata.request"; //$NON-NLS-1$
	/** URI used as the namespace for xml elements */
	public static final String NAMESPACE_URI = "http://eclipse.org/vtp/xml/configuration/attacheddata/request"; //$NON-NLS-1$
