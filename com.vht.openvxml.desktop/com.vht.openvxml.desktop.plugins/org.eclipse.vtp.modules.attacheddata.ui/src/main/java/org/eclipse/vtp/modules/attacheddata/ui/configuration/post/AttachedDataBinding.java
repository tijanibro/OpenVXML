...
/*ts a named set of configuration bindings for attached data
 * submissions. Items and their entries are stored as children to the binding
...
public class AttachedDataBinding extends GenericBinding {
	...
	public GenericBindingItem readBindingItem(Element itemConfiguration) {
		...
		for (int i = 0; i < contentList.getLength(); i++) {
			...
			} else if ("map".equalsIgnoreCase(dataTypeString)) {
