...
public class ConnectWorkflowToUmbrellaWizard extends Wizard {
	...
	public class UmbrellaPage extends WizardPage {
		...
		public void createControl(Composite parent) {
			...
			if (umbrellaProjects.size() > 0) {
				...
				noUmbrellaLabel
						.setText("There currently are no Umbrella projects in the workspace.  You must create one before connecting a workflow project.");
			}
			setControl(comp);
		}
	...
	public class BrandMappingPage extends WizardPage {
		...
		public void setUmbrellaProject(IOpenVXMLProject umbrellaProject) {
			...
			destinationAspect = (IBrandingProjectAspect) umbrellaProject
					.getProjectAspect(IBrandingProjectAspect.ASPECT_ID);
