...
public class OptionSetInformationProvider extends PrimitiveInformationProvider
	...
	public void readConfiguration(org.w3c.dom.Element configuration) {
		...
		MenuChoiceBindingManager mcBindingManager = (MenuChoiceBindingManager) getElement()
	...
	public void updateConfiguration(Element configuration)// TODO add a
															// reference to this
															// in the
															// readconfiguration
															// method
	{
		...
		MenuChoiceBindingManager mcBindingManager = (MenuChoiceBindingManager) getElement()
				.getConfigurationManager(MenuChoiceBindingManager.TYPE_ID); // TODO
		...
		// TODO loop on brands in brandOrders; keys are brand names and values
		// are lists of MenuChoice items
		...
		while (i.hasNext()) {
			...
			for (int b = 0; b < mcList.size(); b++) {
				...
				// TODO verify that this doesn't overwrite prompt/grammar/dtmf
				// data
