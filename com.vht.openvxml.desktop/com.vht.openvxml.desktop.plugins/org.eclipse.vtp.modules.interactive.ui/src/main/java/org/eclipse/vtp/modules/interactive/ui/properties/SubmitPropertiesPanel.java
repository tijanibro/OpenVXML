...
public class SubmitPropertiesPanel extends DesignElementPropertiesPanel {
	...
	/**
	 * A text field used to display/change the name of this particular Submit
	 * module
	 */
	Text nameField = null;
	...
	public void createControls(Composite parent) {
		...
		//
		// timeoutSelectionType = new Combo(timeoutContainer, SWT.DROP_DOWN |
		// SWT.READ_ONLY);
		// gd4 = new GridData();
		// gd4.verticalAlignment = SWT.TOP;
		...
		inputTable.addDoubleClickListener(new IDoubleClickListener() {
			...
			public void doubleClick(DoubleClickEvent event) {
				if (!inputTable.getSelection().isEmpty()) {
					...
					SubmitInput si = (SubmitInput) ((IStructuredSelection) inputTable
	...
	public class InputValueDialog extends FramedDialog {
		 ...
		 * 
		 * @param value
		 *            - the SubmitInput object to modify
		 */
	...
	public void setConfigurationContext(Map<String, Object> values) {
		...
		// brandBinding = languageBinding.getBrandBinding(currentBrand);
		// valuePropertyItem =
		// (PropertyBindingItem)brandBinding.getBindingItem();
		// if(valuePropertyItem == null)
		// {
		// valuePropertyItem = new PropertyBindingItem();
		// }
		...
		// }
		// else
		// if(valuePropertyItem.getValueType().equals(PropertyBindingItem.EXPRESSION))
		// {
		...
		// ObjectDefinition od =
		// VariableHelper.getObjectDefinitionFromVariables(variables,
		// valuePropertyItem.getValue());
	...
	private void storeBindings() {
		try {
			...
			// else
			// valuePropertyItem =
			// (PropertyBindingItem)valuePropertyItem.clone();
			// switch (timeoutSelectionType.getSelectionIndex())
			// {
			// case 2:
