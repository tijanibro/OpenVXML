 ...
 * 
 */
public class BuiltInNumberInputGrammar extends BuiltInInputGrammar
{
	public static final String ELEMENT_NAME = "builtin-number-input-grammar"; //$NON-NLS-1$
	public static final String DATA_IDENTIFIER = "VXML:Builtin:number"; //$NON-NLS-1$
	
	public BuiltInNumberInputGrammar()
	{
		super();
	}

	public BuiltInNumberInputGrammar(Element element)
	{
		super();
	}
    ...
    {
	    return "org.eclipse.vtp.framework.interactions.voice.media.input.builtin.number";
    }
	/* (non-Javadoc)
