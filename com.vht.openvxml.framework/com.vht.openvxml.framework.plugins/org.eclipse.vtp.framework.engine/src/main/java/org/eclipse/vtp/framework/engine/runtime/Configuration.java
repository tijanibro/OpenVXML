...
public class Configuration extends Component {
	 ...
	 * @throws NullPointerException
	 *             If the supplied data is <code>null</code>.
	 */
	public Configuration(Blueprint blueprint,
			ConfigurationDescriptor descriptor, Element data)
			throws NullPointerException {
		...
		String xmlIdentifier = RuntimeUtils.getQualifiedIdentifier(
				descriptor.getXmlTag(), descriptor.getXmlNamespace());
	 ...
	 *            The inherited service registry to use.
	 * @return A new instance of the configuration component.
	 * @throws NullPointerException
	 *             If the supplied service registry is <code>null</code>.
	 */
