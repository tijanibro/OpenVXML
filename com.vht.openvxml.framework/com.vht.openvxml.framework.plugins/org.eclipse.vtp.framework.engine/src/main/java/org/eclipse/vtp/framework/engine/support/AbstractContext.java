...
public abstract class AbstractContext extends AbstractLogger implements
	 ...
	 * 
	 * @param identifier
	 *            The identifier of the service to return, will never be
	 *            <code>null</code>.
	...
	/**
	 * Returns all the services registered under the specified identifier in
	 * this registry or <code>null</code> if no such services can be found.
	 * 
	 * @param identifier
	 *            The identifier of the services to return, will never be
	 *            <code>null</code>.
	 * @return All the services registered under the specified identifier in
	 *         this registry or <code>null</code> if no such services can be
	 *         found.
	 */
	...
	/**
	 * Returns a service registered under the specified identifier in any
	 * ancestor registry or <code>null</code> if no such service exists.
	 * 
	 * @param identifier
	 *            The identifier of the service to return, will never be
	 *            <code>null</code>.
	 * @return A service registered under the specified identifier in any
	 *         ancestor registry or <code>null</code> if no such service exists.
	 */
