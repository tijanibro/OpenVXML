...
public final class RuntimeUtils {
	 ...
	 * 
	 * @param identifier
	 *            The identifier to be qualified.
	 * @param qualifier
	 *            The qualifier of the identifier.
	 * @return A unique string from the supplied name space and identifier.
	 * @throws NullPointerException
	 *             If supplied identifier is <code>null</code>.
	 * @throws NullPointerException
	 *             If supplied qualifier is <code>null</code>.
	 */
	 ...
	 * 
	 * @param element
	 *            The element to generate the identifier for.
	 * @return A unique string from the supplied element's name space URI and
	 *         tag name.
	 * @throws NullPointerException
	 *             If supplied element is <code>null</code>.
	 */
	public static String getXMLIdentifier(Element element)
		...
		return getQualifiedIdentifier(element.getLocalName(),
	 ...
	 * 
	 * @param type
	 *            The type to list the hierarchy of.
	 * @param types
	 *            The set to populate with classes.
	 * @throws NullPointerException
	 *             If the supplied set is <code>null</code>.
	 */
	public static void listTypeHierarchy(Class type, Set types)
		...
		if (interfaces != null) {
			for (Class interface1 : interfaces) {
				listTypeHierarchy(interface1, types);
			}
		}
		types.add(type);
	}
	...
	/**
	 * Creates a new instance of the specified class via the supplied
	 * constructor.
	 * 
	 * @param constructor
	 *            The constructor to create the object with.
	 * @param arguments
	 *            The arguments to satisfy the constructor with.
	 * @return The new object instance.
	 * @throws IllegalArgumentException
	 *             If the supplied constructor argument array has more or less
	 *             elements than the specified constructor does arguments.
	 * @throws IllegalStateException
	 *             If the object creation fails.
	 * @throws NullPointerException
	 *             If the supplied constructor is <code>null</code>.
	 * @throws NullPointerException
	 *             If the supplied constructor argument array or any of its
	 *             elements are <code>null</code>.
	 */
	public static Object createInstance(Constructor constructor,
			Object[] arguments) throws IllegalStateException,
	 ...
	 * @param mutator
	 *            The property mutator method to invoke.
	 * @param value
	 *            The value to set the property to.
	 * @throws IllegalArgumentException
	 *             If the supplied mutator does not take exactly one argument.
	 * @throws IllegalStateException
	 *             If the object creation fails.
	 * @throws NullPointerException
	 *             If the supplied instance is <code>null</code>.
	 * @throws NullPointerException
	 *             If the supplied mutator is <code>null</code>.
	 */
