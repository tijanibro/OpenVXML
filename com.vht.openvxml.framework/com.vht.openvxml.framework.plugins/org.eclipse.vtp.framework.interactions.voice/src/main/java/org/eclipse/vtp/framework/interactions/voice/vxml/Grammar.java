...
public class Grammar extends Widget implements VXMLConstants {
	...
	public void writeWidget(ContentHandler outputHandler)
		...
		outputHandler.startElement(NAMESPACE_URI_VXML, NAME_GRAMMAR,
				NAME_GRAMMAR, attributes);
		// Write any children.
		writeChildren(outputHandler);
		// End the element.
		outputHandler
				.endElement(NAMESPACE_URI_VXML, NAME_GRAMMAR, NAME_GRAMMAR);
	}
	 ...
	 * @throws SAXException
	 *             If the writing of one of the children fails.
	 */
