...
public class BuiltInDateInputGrammar extends BuiltInInputGrammar {
	...
	public static final String DATA_IDENTIFIER = "VXML:Builtin:date"; //$NON-NLS-1$

	public BuiltInDateInputGrammar() {
		super();
	}

	public BuiltInDateInputGrammar(Element element) {
		super(element);
	}
	...
	public String getInputGrammarType() {
		return "org.eclipse.vtp.framework.interactions.voice.media.input.builtin.date";
	}
