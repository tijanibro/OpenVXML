...
/**
 * The <code>Error</code> class represents the &lt;error&gt; VXML element. This
 * type of event handler only receives errors. Error event names start with
 * "error." and can be well known or platform specific.<br>
 * <br>
 * An <code>Error</code> instance catches only errors with names that match the
 * specified name. The specified error name matches if it is equal to or is a
 * prefix of the name of the generated error.<br>
 * <br>
...
public class Error extends Catch {
	 ...
	 * 
	 * @param errorName
	 *            The name or prefix of the errors to catch.
	 * @throws IllegalArgumentException
	 *             If the supplied error name is empty.
	 * @throws NullPointerException
	 *             If the supplied error name is <code>null</code>.
	 */
	 ...
	 *            The name or prefix of the errors to catch.
	 * @param count
	 *            The occurrence of the named error to catch.
	 * @throws IllegalArgumentException
	 *             If the supplied error name is empty.
	 * @throws NullPointerException
	 *             If the supplied error name is <code>null</code>.
	 ...
	 * when the conditional expression evaluates to <code>true</code>. Throws an
	 * IllegalArgumentException if the error name is <code>null</code>.
	 * 
	 * @param errorName
	 *            The name or prefix of the errors to catch.
	 * @param condition
	 *            An expression that must evaluate to true for this instance to
	 *            catch an error.
	 * @throws IllegalArgumentException
	 *             If the supplied error name is empty.
	 * @throws IllegalArgumentException
