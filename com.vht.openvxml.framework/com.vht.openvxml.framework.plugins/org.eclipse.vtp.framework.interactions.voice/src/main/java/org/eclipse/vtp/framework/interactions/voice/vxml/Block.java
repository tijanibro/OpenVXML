 ...
 * actions to be executed during the processing of a VXML <code>Form</code>. The
 * actions are executed in the order in which they are added to the
 * <code>Block</code> instance.
 * 
 * <code>Variable</code>s can also be declared in a block element and referenced
 * later during the processing of the form.
 * 
 * @author Trip Gilman
 * @author Lonnie Pryor
 * @version 2.0
...
public class Block extends FormElement {
	 ...
	 *            The name of the block element.
	 * @param expression
	 *            An expression that will set the initial value of the block
	 *            element.
	 * @throws IllegalArgumentException
	 *             If the specified name is empty.
	 * @throws IllegalArgumentException
	 ...
	 *            element.
	 * @param condition
	 *            An expression that equates to a boolean value which determines
	 *            if the block will be executed.
	 * @throws IllegalArgumentException
	 *             If the specified name is empty.
	 * @throws IllegalArgumentException
	 *             If the specified expression is empty.
	...
	/**
	 * Adds the action to the list of actions to perform if this block element
	 * is executed.
	 * 
	 * @param action
	 *            The action to add.
	 ...
	 * 
	 * @param ifClause
	 *            The If clause to add.
	 * @throws NullPointerException
	 *             If the specified if clause is <code>null</code>.
	 */
	...
	/**
	 * Removes a set of conditional actions from the list of actions to perform
	 * if this block element is executed.
	 * 
	 * @param ifClause
	 *            The If clause to remove.
	 * @throws NullPointerException
	 *             If the specified if clause is <code>null</code>.
	 */
