...
/**
 * The <code>AudioOutput</code> class represents the &lt;audio&gt; VXML element
 * and specifies the location of an audio file to be played to the caller.
 * 
...
public class AudioOutput extends OutputSet {
	 ...
	 * audio file URI. The URI passed in may be a string literal or an
	 * expression that will evaluate to the desired string literal.
	 * 
	 * @param audioFileURI
	 *            The URI of the audio file to play to the caller.
