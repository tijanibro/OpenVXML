...
/**
 * The <code>Recording</code> class represents the &lt;record&gt; VXML element.
 * 
 * @author Trip Gilman
 * @author Lonnie Pryor
 * @version 2.0
...
public class Recording extends FormElement {
	 ...
	 * 
	 * @param name
	 *            The name of the recording element.
	 ...
	 *            The name of the recording element.
	 * @param expression
	 *            An expression that will set the initial value of the recording
	 *            element.
	 * @throws IllegalArgumentException
	 *             If the specified name is empty.
	 * @throws IllegalArgumentException
	 ...
	 *            if the recording will be executed.
	 * @throws IllegalArgumentException
	 *             If the specified name is empty.
	 * @throws IllegalArgumentException
	 *             If the specified expression is empty.
	 ...
	 *            The maximum recording time setting.
	 * @throws IllegalArgumentException
	 *             If the specified setting is empty.
	 */
	...
	public void writeWidget(ContentHandler outputHandler)
		...
		outputHandler.startElement(NAMESPACE_URI_VXML, NAME_RECORD,
				NAME_RECORD, attributes);
		// Write the children.
	...
	protected void writeAttributes(AttributesImpl attributes) {
		...
		writeAttribute(attributes, null, null, NAME_BEEP, TYPE_CDATA,
				String.valueOf(beepEnabled));
		writeAttribute(attributes, null, null, NAME_DTMFTERM, TYPE_CDATA,
				String.valueOf(dtmfTermEnabled));
		if (maxtime != null) {
			writeAttribute(attributes, null, null, NAME_MAXTIME, TYPE_CDATA,
					maxtime);
		}
		if (finalSilence != null) {
			writeAttribute(attributes, null, null, NAME_FINALSILENCE,
					TYPE_CDATA, finalSilence);
		}
		if (fileType != null) {
