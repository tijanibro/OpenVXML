...
public class Option extends Widget implements VXMLConstants {
	 ...
	 *             If the supplied DTMF value is empty.
	 */
	...
	/**
	 * Creates a new instance of <code>Option</code> with the specified TTS
	 * output, DTMF grammar, and value. Throws an IllegalArgumentException if
	 * the dtmf or value arguments are empty strings.
	 * 
	 * @param output
	 *            The TTS output to play to the caller.
	 * @param dtmf
	 *            The DTMF grammar that selects this option.
	 * @param value
	 *            The value to assign to the field element if this option is
	 *            selected.
	 * @throws IllegalArgumentException
	 *             If the supplied DTMF value is empty.
	 * @throws IllegalArgumentException
	 *             If the supplied option value is empty.
	 */
	...
	/**
	 * Returns the value that will be assigned to the field element if this
	 * option is selected.
	 * 
	 * @return the value that will be assigned to the field element if this
	 *         option is selected.
	 */
	...
	/**
	 * Sets the value that will be assigned to the field element if this option
	 * is selected. Throws an IllegalArgumentException if the value argument is
	 * an empty string.
	 * 
	 * @param value
	...
	public void writeWidget(ContentHandler outputHandler)
		...
		outputHandler.startElement(NAMESPACE_URI_VXML, NAME_OPTION,
				NAME_OPTION, attributes);
		// Write the children.
	...
	protected void writeAttributes(AttributesImpl attributes) {
		...
		if (value != null) {
			writeAttribute(attributes, null, null, NAME_VALUE, TYPE_CDATA,
					value);
		}
	}
