...
/**
 * The <code>ElseIf</code> class represents the &lt;elseif&gt; VXML element. It
 * contains a list of actions for the VXML interpreter to execute if its
...
public class ElseIf extends Widget implements VXMLConstants {
	...
	public void writeWidget(ContentHandler outputHandler)
		...
		outputHandler.startElement(NAMESPACE_URI_VXML, NAME_ELSEIF,
				NAME_ELSEIF, attributes);
