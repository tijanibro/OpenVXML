...
/**
 * The <code>Form</code> class represents the &lt;form&gt; VXML element. A form
 * can contain any number of <code>Block</code> and <code>Field</code> elements.
 * The child elements are presented to the caller in the order they were added
 * to the form.<br>
 * <br>
...
public class Form extends Dialog {
	 ...
	 */
	public Form(String id) throws IllegalArgumentException,
	...
	public FormElement[] getFormElements() {
		return formElements.toArray(new FormElement[formElements.size()]);
	}
	...
	/**
	 * Adds the specified variable element to this form. Variables declared at
	 * the form level are accessible to all child elements.
	 * 
	 * @param variable
	 *            The variable to add.
	 * @throws NullPointerException
	 ...
	 * @throws NullPointerException
	 *             If the supplied element is <code>null</code>.
	 */
	...
	/**
	 * Adds the specified filled handler to this form. Filled handlers at the
	 * form level are processed when some or all of the form's child elements
	 * are set, depending on the mode of the handler. Filled handlers are
	 * executed in the order they were added.
	 * 
	 * @param filled
	 *            The filled handler to add.
	 * @throws NullPointerException
	...
	public void writeWidget(ContentHandler outputHandler)
		...
		outputHandler.startElement(NAMESPACE_URI_VXML, NAME_FORM, NAME_FORM,
				attributes);
		// Write the children.
	 ...
	 *             If the supplied content handler is <code>null</code>.
	 * @throws SAXException
	 *             If the writing of one of the elements fails.
	 */
