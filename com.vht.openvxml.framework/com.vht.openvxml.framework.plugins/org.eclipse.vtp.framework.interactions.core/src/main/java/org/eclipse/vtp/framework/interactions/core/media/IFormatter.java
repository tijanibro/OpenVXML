 ...
 * objects that contain the transformed information, e.g. a TextContent with the
 * text "Monday, March 31st, 2008".
 * 
 * @author trip
 *
 */
public interface IFormatter {
	 ...
	 *
	 * @param digits
	 *            The digits to translate to text.
	 * @param formatDefinition
	 *            The provided specialized format to use during transformation.
	 * @param formatOptions
	 *            TODO
	 ...
	 * @return A list of
	 *         <code>org.eclipse.vtp.framework.interactions.core.media.Content</code>
	 *         objects that contain the formatted elements of the provided
	 *         sequence of digits.
	 */
	List<Content> formatDigits(String digits, String formatDefinition,
			String formatOptions, IResourceManager resourceManager);

	/**
	 * Transforms the supplied monetary amount into a language specific sequence
	 * of elements following the given definition using the provided resource
	 ...
	 *
	 * @param money
	 *            The amount to translate to text.
	 * @param currency
	 ...
	 *         monetary value.
	 */
	List<Content> formatMoney(BigDecimal money, Currency currency,
	 ...
	 *         number.
	 */
	List<Content> formatNumber(int number, String formatDefinition,
			String formatOptions, IResourceManager resourceManager);

	/**
	 * Transforms the supplied ordinal value into a language specific sequence
	 * of elements following the given definition using the provided resource
	 * manager to locate file resources.<br>
	 * <br>
	 * If the definition is not recognized or invalid, the default definition
	 ...
	 *
	 * @param ordinal
	 *            The ordinal to translate to text.
	 * @param formatDefinition
	 *            The provided specialized format to use during transformation.
	 * @param resourceManager
	 *            Provides access to the available file resources.
	 ...
	 *         ordinal value.
	 */
	List<Content> formatOrdinal(int ordinal, String formatDefinition,
			String formatOptions, IResourceManager resourceManager);
	 ...
	 *         string of letters.
	 */
	List<Content> formatLetters(String text, String formatDefinition,
			String formatOptions, IResourceManager resourceManager);
	 ...
	 * 
	 * @param formattable
	 *            The type of content to find specializations for.
	...
	/**
	 * Returns the string representation of the specialization of the given name
	 * and for the given formattable content type. This name/definition
	 ...
	 * 
	 * @param formattable
	 *            The type of content to retrieve the definition for.
	 * @param formatName
	 *            The name of the definition.
	 * @return The format definition.
	 */
	String getDefaultFormatDefintion(FormattableContent formattable,
			String formatName);
}
