...
public interface IExecutionContext extends ISessionContext {
	...
	/**
	 * Returns the value of the execution-level parameter with the specified
	 * name or <code>null</code> if no such parameter exists.
	 * 
	 * @param parameterName
	 *            The name of the parameter to return.
	 * @return The value of the execution-level parameter with the specified
	 *         name or <code>null</code> if no such parameter exists.
	...
	/**
	 * Returns the values of the execution-level parameter with the specified
	 * name or <code>null</code> if no such parameter exists.
	 * 
	 * @param parameterName
	 *            The name of the parameter to return.
	 * @return The values of the execution-level parameter with the specified
	 *         name or <code>null</code> if no such parameter exists.
	 * @throws NullPointerException
	 *             If the supplied parameter name is <code>null</code>.
	 */
	...
	/**
	 * Sets the value of the execution-level parameter with the specified name
	 * or clears it if the value is <code>null</code>.
	 * 
	 * @param parameterName
	 *            The name of the parameter to set.
	 * @param value
	 *            The value of the execution-level parameter with the specified
	...
	/**
	 * Sets the values of the execution-level parameter with the specified name
	 * or clears them if the value is <code>null</code> or empty.
	 * 
	 * @param parameterName
	 *            The name of the parameters to set.
	 * @param values
	 *            The values of the execution-level parameter with the specified
	 *            name or <code>null</code> or to clear the values.
	 * @throws NullPointerException
	 *             If the supplied parameter name is <code>null</code>.
	 */
	...
	/**
	 * Clears the value of the execution-level parameter with the specified
	 * name.
	 * 
	 * @param parameterName
