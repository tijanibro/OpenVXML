...
public class DialogicPlatform extends VoicePlatform {
	...
	public void generateInitialVariableRequests(Map variables) {
		...
		// This variable seems to be causing an error. Accordingly, it has been
		// disabled.
		// variables.put("criticaldigit_timer",
		// "com.snowshore.criticaldigit_timer");

		// TODO maybe set up an object structure for these protocol.x,
		// protocol.sip.y etc?
